    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(default=chats.models.generate_default_username, max_length=150, unique=True)),
                ('password', models.CharField(max_length=128)),
                ('first_name', models.CharField(max_length=30)),
                ('last_name', models.CharField(max_length=30)),
                ('status', models.CharField(default='Hey there! Im using ChatApp', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['sent_at'],
                'indexes': [models.Index(fields=['conversation', 'sent_at'], name='chats_messa_convers_d4d1d7_idx')],
            },
        ),
    ]
